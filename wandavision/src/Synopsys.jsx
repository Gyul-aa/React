...
const episode = [
    {
      ...
      synopsis: '비전의 직장 상사 부부를 초대한 식사 자리에서 완다와 부부는 그들의 능력을 감추기 위해 애쓴다.',
      style: {
    ...
    },
    {
      ...
      synopsis: '마을 사람들과 어울리기 위한 노력으로 완다와 비전은 마을의 장기 자랑 대회에서 마술 연기를 선보인다.',
      style: {
    ...
    },
    {
      id: 3,
      title: 'Now in color',
      synopsis: '완다가 임신으로 인해 능력을 제어하기가 어려워지고, 완다와 비전은 빠르게 진행되는 분만을 준비한다.',
      style: {
    ...
    },
    {
      ...
      synopsis: '지각이 있는 무기와 관련된 특별 임무를 맡은 모니카 램보 대위가 실종된다.',
      style: {
    ...
    },
    {
      ...
      synopsis: '비전이 이웃들의 이상한 행동에 의심을 품기 시작하자 완다가 그의 염려에 신경을 쏟기 시작한다.',
      style: {
    ...
    },
    {
      ...
      synopsis: '핼러윈 소동으로 인해 완다와 잠시 떨어진 비전이 웨스트뷰의 변칙 현상을 발견하게 된다.',
      style: {
    ...
    },
    {
      ...
      synopsis: '완다가 불안정한 현상을 겪는 동안 모니카는 변칙 세계로 돌아갈 궁리를 하고 비전은 도움을 받기 위해 동맹을 맺는다.',
      style: {
    ...
    },
    {
      id: 8,
      title: 'Previously On',
      synopsis: '완다는 현재와 미래에 대한 통찰력을 얻기 위해 과거로 돌아가는 시간 여행에 착수한다.',
      style: {
    ...
    },
    {
      ...
      synopsis: '완다 비전 사건이 위기에 봉착하고 관련된 모든 이들의 운명이 결정된다.',
      style: {
